      ...
      <Modal
        ...
        <View style={designs.modalWrapper}>
          <View style={designs.modalView}>
            ...
            <View>
              <Text style={designs.modalTitleText}>
                Relationship with your Referee
              </Text>
              <Text style={[designs.modalBodyText, {marginLeft: 10}]}>
                Search
              </Text>
              <View>
                {relationships.map((relationship, index) => {
                  return (
                    <TouchableOpacity
                      key={index}
                      onPress={() => {
                        controller.selectItem(relationship.value);
                        controller.close();
                        setPickerModalOpen(false);
                      }}
                      style={{marginBottom: 22, marginLeft: 10}}>
                      <Text
                        style={[
                          designs.buttonText,
                          {fontSize: 16, lineHeight: 20, fontWeight: 'normal'},
                        ]}>
                        {relationship.label}
                      </Text>
                    </TouchableOpacity>
