...
const RentalLoanForm2 = ({navigation}) => {
  ...
  const [companyAddressNumberAndStreet, setCompanyAddressNumberAndStreet] = useState('');
      ...
      />
        <View
          ...
          <View style={{flexDirection: 'row', alignItems: 'center'}}>
            <Text style={{fontSize: 12, lineHeight: 15, color: '#ADADAD', marginRight: 15}}>2 of 3</Text>
  ...
  backgroundColor="#D6D6D6" />
          ...
          <Text style={[FONTS.body1FontStyling, {color: COLORS.dark, marginBottom: 8}]}>What’s the name of the company you work for? </Text>
         <TextInput
...
<Text style={[FONTS.body1FontStyling, {color: COLORS.dark, marginBottom: 8}]}>Address of the company?</Text> 
            <TextInput
