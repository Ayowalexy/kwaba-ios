...
const ConnectWithMono = () => {
  ...
  return <TouchableOpacity
            ...
            <Text style={[designs.buttonText, {color: COLORS.white, textAlign: 'center', fontWeight: 'normal'}]}>CONNECT</Text>
          </TouchableOpacity>
};
    ...
    <View style={[designs.container, {backgroundColor: '#F7F8FD'}]}>
      ...
      />
        <View
          ...
          <Text style={[FONTS.body2FontStyling, {color: '#ADADAD', textAlign: 'center', marginBottom: 26}]}>Connect your salary bank account via your mobile/internet banking. </Text>
