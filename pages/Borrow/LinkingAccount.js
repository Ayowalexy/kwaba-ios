...
export default function LinkingAccount ({navigation, route}) {
  ...
  return (
    <View style={[designs.container, {justifyContent: 'center', alignItems: 'center', backgroundColor: '#00000050', paddingHorizontal: 21}]}>
      <View style={designs.cardLYA}>
        ...
        <View style={{marginTop: 9}}>
          ...
          Linking this account to RentBank only gives us read-only access to know the value of your asset in the account.
          </Text>
        </View>

        <TouchableOpacity
          onPress={() => navigation.navigate('ThirdPartyLink', item)}
          style={[designs.buttonStyleB, {...Platform.select({
            ios: {
                shadowColor: '#000',
