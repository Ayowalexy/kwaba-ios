        ...
        <View style={{flexDirection: 'column', alignItems: 'center'}}>
          <View style={[designs.customInput, {width: widthtouse * 0.9}]}>
            <Text
              style={{
                color: COLORS.grey,
                fontSize: firstname == '' ? 16 : 10,
                lineHeight: firstname == '' ? 30 : 10,
                marginBottom: firstname == '' ? 0 : 23,
              }}>
              First name
            </Text>
          ...
          <View style={[designs.customInput, {width: widthtouse * 0.9}]}>
            <Text
              style={{
                color: COLORS.grey,
                fontSize: lastname == '' ? 16 : 10,
                lineHeight: lastname == '' ? 30 : 10,
                marginBottom: lastname == '' ? 0 : 23,
              }}>
              Last name
            </Text>
            <TextInput
          ...
          <View style={[designs.customInput, {width: widthtouse * 0.9}]}>
            <Text
              style={{
                color: COLORS.grey,
                fontSize: dateOfBirth == '' ? 16 : 10,
                lineHeight: dateOfBirth == '' ? 30 : 10,
                marginBottom: dateOfBirth == '' ? 0 : 23,
              }}>
              Date of Birth
            </Text>
            <TextInput
          ...
          <View style={[designs.customInput, {width: widthtouse * 0.9}]}>
            <Text
              style={{
                color: COLORS.grey,
                fontSize: address == '' ? 16 : 10,
                lineHeight: address == '' ? 30 : 10,
                marginBottom: address == '' ? 0 : 23,
              }}>
              Address
            </Text>
            <TextInput
      ...
      <View
        ...
        <View style={[designs.customInput, {width: widthtouse * 0.9}]}>
          <Text
            style={{
              color: COLORS.grey,
              fontSize: nameOfCompany == '' ? 16 : 10,
              lineHeight: nameOfCompany == '' ? 30 : 10,
              marginBottom: nameOfCompany == '' ? 0 : 23,
            }}>
            Name Of Company
          </Text>
          <TextInput
        ...
        <View style={[designs.customInput, {width: widthtouse * 0.9}]}>
          <Text
            style={{
              color: COLORS.grey,
              fontSize: companyLocation == '' ? 16 : 10,
              lineHeight: companyLocation == '' ? 30 : 10,
              marginBottom: companyLocation == '' ? 0 : 23,
            }}>
            Location
          </Text>
          <TextInput
      ...
      <View
        ...
        <View style={[designs.customInput, {width: widthtouse * 0.9}]}>
          <Text
            style={{
              color: COLORS.grey,
              fontSize: email == '' ? 16 : 10,
              lineHeight: email == '' ? 30 : 10,
              marginBottom: email == '' ? 0 : 23,
            }}>
            Email
          </Text>
          <TextInput
        ...
        <View style={[designs.customInput, {width: widthtouse * 0.9}]}>
          <Text
            style={{
              color: COLORS.grey,
              fontSize: phoneNumber == '' ? 16 : 10,
              lineHeight: phoneNumber == '' ? 30 : 10,
              marginBottom: phoneNumber == '' ? 0 : 23,
            }}>
            Phone Number
          </Text>
          <TextInput
        ...
        <View style={[designs.customInput, {width: widthtouse * 0.9}]}>
          <Text
            style={{
              color: COLORS.grey,
              fontSize: bvn == '' ? 16 : 10,
              lineHeight: bvn == '' ? 30 : 10,
              marginBottom: bvn == '' ? 0 : 23,
            }}>
            Bvn
          </Text>
          <TextInput
    ...
    renderLabel={({route, focused, color}) => (
      <Text
        style={{
          ...
          margin: 0,
          backgroundColor: focused ? '#9D98EC' : 'white',
          height: 32,
          textAlign: 'center',
          width: 100,
          paddingTop: 6,
