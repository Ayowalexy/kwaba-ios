...
const CreditCardFormRNPL: React.FC = (props: any) => {
  ...
  //   const url = 'https://kwaba-main-api-3-cp4jm.ondigitalocean.app/api/v1/verify_savings_payment';
  //   try {
  ...
  //   const token = await getToken();
  //   const url = 'https://kwaba-main-api-3-cp4jm.ondigitalocean.app/api/v1/application/payment/verify';
  //   try {
  ...
  // RNPL repayment payment verification -
  ...
  const onSubmit = async (model: FormModel) => {
    ...
    // });
    // const verify = await rentPaymentVerify(pay);
